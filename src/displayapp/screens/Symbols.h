  ...
  namespace Applications {
    namespace Screens {
      namespace Symbols {
        ...
        static constexpr const char* alarmClock = "\xEF\x8D\x8E";
        static constexpr const char* info = "\xEF\x81\x9A";
        ...
        static constexpr const char* mail = "\xEF\x83\xA0";
        ...
        static constexpr const char* bluetoothOn = "\xEE\x86\xA7";
        static constexpr const char* bluetoothOff = "\xEE\x86\xA9";
