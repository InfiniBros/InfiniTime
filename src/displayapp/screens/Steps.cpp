...
Steps::Steps(Controllers::MotionController& motionController, Controllers::Settings& settingsController)
  ...
  lv_obj_align(lSteps, nullptr, LV_ALIGN_CENTER, 0, -50);
  ...
  lv_obj_align(lStepsYesterday, lSteps, LV_ALIGN_OUT_BOTTOM_MID, 0, 30);
  ...
  lv_obj_align(lstepsGoal, lSteps, LV_ALIGN_OUT_BOTTOM_MID, 0, 50);
